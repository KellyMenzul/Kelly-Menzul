...
export default function MindfulApp() {
  ...
  useEffect(()=> {
    ...
    console.log("use effect hook, inView3 = ", inView3);
  }, [inView3]);
  ...
  useEffect(()=> {
    ...
    console.log("use effect hook, inView4 = ", inView4);
  }, [inView4]);
  ...
  useEffect(()=> {
    ...
    console.log("use effect hook, inView5 = ", inView5);
  }, [inView5]);
  ...
  useEffect(()=> {
    ...
    console.log("use effect hook, inView2 = ", inView6);
  }, [inView6]);
  ...
  useEffect(()=> {
    ...
    if(!inView7){
      animation7.start({opacity:0, y:50})
    }
    console.log("use effect hook, inView7 = ", inView7);
  }, [inView7]);
  ...
  useEffect(()=> {
    ...
    if(!inView8){
      animation8.start({opacity:0, y:50})
    }
    console.log("use effect hook, inView8 = ", inView8);
  }, [inView8]);
  ...
  useEffect(()=> {
    ...
    if(!inView9){
      animation9.start({opacity:0, y:50})
    }
    console.log("use effect hook, inView9 = ", inView9);
  }, [inView9]);
  ...
  useEffect(()=> {
    ...
    if(!inView10){
      animation10.start({opacity:0, y:50})
    }
    console.log("use effect hook, inView2 = ", inView10);
  }, [inView10]);
  ...
  useEffect(()=> {
    ...
    if(!inView11){
      animation11.start({opacity:0, y:50})
    }
    console.log("use effect hook, inView11 = ", inView11);
  }, [inView11]);
  ...
  return (
    ...
    visible: {
      ...
      >
        ...
        <ButtonHolder2 as={motion.div} ref={ref2} animate={animation2}>
        ...
        <ImageHolder as={motion.div} ref={ref3} animate={animation3}>
          <ImageOne src='/mindfulmockup.png'/>
        </ImageHolder>

        <DeliverableHolder as={motion.div} ref={ref4} animate={animation4}>
        ...
        <ProcessHolder as={motion.div} ref={ref5} animate={animation5}>
        ...
        <ImageHolder as={motion.div} ref={ref6} animate={animation6}>
          <ImageTwo src='/mindful.png'/>
        </ImageHolder>

        <ProcessHolder as={motion.div} ref={ref7} animate={animation7}>
        ...
        <ImageHolderPer as={motion.div} ref={ref8} animate={animation8}>
        ...
        <ProcessHolder as={motion.div} ref={ref9} animate={animation9}>
        ...
        <ThankHolder as={motion.div} ref={ref10} animate={animation10}>
