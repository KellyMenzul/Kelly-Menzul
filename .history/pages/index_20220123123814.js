  ...
  return (
    <Holder>
      ...
      <ContainerLeft>
            ...
            <Screens info='Fron-end Development | UX/UI Design' linkhref='/tinypaws' src='tinypawsscreen.png' name='Tinypaws' />
          </ContainerLeft>
          <ContainerRight>
            <Screens info='Fron-end Development | UX/UI Design' linkhref='/wecycle' name='Wecycle' src='wecyclescreen.png'/>
            <Screens linkhref='/frankocean' src='frankoceanscreen.png' name='Frank Ocean'/>
          </ContainerRight>
      </WorkHolder>
