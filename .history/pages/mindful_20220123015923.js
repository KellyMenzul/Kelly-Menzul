...
export default function Tinypaws() {
  ...
  return (
      <Container>
        ...
        <ProcessHolder>
          <Process head='The Solution' text='Mindful is an application with features that encourage the user to take a moment out of their day to practice mindful reflections, whether that be how they feel, what they did that day, or just talk in general. '/>
        </ProcessHolder>
