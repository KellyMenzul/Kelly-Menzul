...
export default function FrankOcean() {
  ...
  return (
      <Container>
        ...
        <ImageHolderPer>
          <ImageTwo src='/frnakonceanfive.png'/>
        </ImageHolderPer>

        <ProcessHolder>
          <Process head='The Solution' text='Implement a lyric analysis blog, a music room, audio throughout the website, and interactive components throughout the site'/>
        </ProcessHolder>
