...
export default function MindfulApp() {
  ...
  return (
      ...
      >
        ...
        <ProcessHolder>
          <Process head='The Solution' text='Design an interactive application with easy navigation. Implement fun graphics that are appealing to the target user and '/>
        </ProcessHolder>
