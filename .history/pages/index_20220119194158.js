...
export default function Home() {
  return (
    <Holder>
      ...
      <WorkHolder id='work'>
        <WorkHolderLeft>
          <Work text='I craft and develop cross platform interfaces with intuitive user experience.' headsize='I Build'/>
        </WorkHolderLeft>
        <WorkHolderRight>
          <Work text='I craft and develop cross platform interfaces with intuitive user experience.' headsize='I Design'/>
        </WorkHolderRight>
