...
export default function MindfulApp() {
  ...
  return (
      ...
      >
        ...
        <ProcessHolder>
          <Process text='There is a negative stigma about mental health in today’s society. People refrain from having an open discussion about their emotions with others. Through our user survey, we were able to '/>
        </ProcessHolder>
