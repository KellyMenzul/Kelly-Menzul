...
export default function Wecycle() {
  ...
  return (
      <Container>
        ...
        <DeliverableHolder>
          <ProjectDeliverable projecttext='Our mission is to educate our users about the importance of recycling. We want to be the bridge between parents/teachers and children when it comes to an engaging and fun learning experience.
