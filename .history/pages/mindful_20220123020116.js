...
export default function Tinypaws() {
  ...
  return (
      <Container>
        ...
        <ProcessHolder>
          <Process head='The Solution' text='Mindful is an application with features such as the journal section, infinite jokes card, breathe tool, chat system (coming soon)'/>
        </ProcessHolder>
