...
export default function FrankOcean() {
  ...
  return (
      <Container>
        ...
        <ProcessHolder>
          <Process head='The Ideation' text='There is a negative stigma about talking about mental health in today’s society. People from normalizing having an open discussion about their emotions with others'/>
        </ProcessHolder>
