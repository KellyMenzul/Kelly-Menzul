...
export default function FrankOcean() {
  ...
  return (
      <Container>
        ...
        <ProcessHolder>
          <Process head='The Process' text='Mindful is focused on managing the user’s mental health which includes emotions and well-being. It is a companion that encourages improving and maintaining one’s mental state in a healthy approach using mindful reflections.'/>
        </ProcessHolder>
