...
export default function Wecycle() {
  ...
  return (
      <Container>
        ...
        <ProcessHolder>
          <Process text="Waste management is prevelant in today's world however children in schools and at home have difficulties paying attention and retaining information"/>
        </ProcessHolder>
