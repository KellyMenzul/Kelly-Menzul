...
export default function Tinypaws() {
  ...
  return (
      <Container>
        ...
        <ProcessHolder>
          <Process text='There is a negative stigma about talking about mental health in today’s society. People refrain from normalizing having an open discussion a'/>
        </ProcessHolder>
