...
export default function FrankOcean() {
  ...
  return (
      <Container>
        ...
        <ProcessHolder>
          <Process head='The Ideation' text='create a this website to possibly help someone who is going through tough situations and use music as a way to feel better.'/>
        </ProcessHolder>
