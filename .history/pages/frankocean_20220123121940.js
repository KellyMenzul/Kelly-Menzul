...
export default function FrankOcean() {
  ...
  return (
      <Container>
        ...
        <DeliverableHolder>
          <ProjectDeliverable projecttext='This website is about Frank Ocean who is an American songwriter, it would includes about him, his music, albums, and his lyrics. It would display some of his best works and lyrics for people to see. The website is meant to give the user some new music discoveries and inspiration or for fans to come and appreciate more of his art'
