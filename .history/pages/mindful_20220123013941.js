...
export default function Tinypaws() {
  ...
  return (
      <Container>
        ...
        <ProcessHolder>
          <Process text='There is a negative stigma about talking about mental health in today’s society. People hold back on sharing about their feelings because they find it to be too much work or they feel as if they are a burden.'/>
        </ProcessHolder>
