...
export default function Home() {
  ...
  return (
    <Holder>
      ...
      <WorkHolder id='work'>
      <ContainerLeft>
            <Screens info='Fron-end Development | UX/UI Design' linkhref='/mindful' name='Mindful'/>
            <Screens info='UX/UI Design' info='Fron-end Development | UX/UI Design' linkhref='/tinypaws' src='tinypawsscreen.png' name='Tinypaws' />
          </ContainerLeft>
          <ContainerRight>
            <Screens info='UX/UI Design' linkhref='/wecycle' name='Wecycle' src='wecyclescreen.png'/>
            <Screens info='UX/UI Design' linkhref='/frankocean' src='frankoceanscreen.png' name='Frank Ocean'/>
          </ContainerRight>
      </WorkHolder>
