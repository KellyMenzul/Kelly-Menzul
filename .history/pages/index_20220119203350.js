...
export default function Home() {
  return (
    <Holder>
      <MenuHolder>
        <MenuBar onButtonPress={bgcolor="black"}/>
      </MenuHolder>
      ...
      <WorkHolder id='work'>
        <WorkHolderLeft>
          <Work buttontext="See what I've built" text='I craft and develop cross platform interfaces with intuitive user experience.' headerhere='I Build'/>
        </WorkHolderLeft>
        <WorkHolderRight>
          <Work buttontext="See what I've designed" text='I craft and develop cross platform interfaces with intuitive user experience.' headerhere='I Design'/>
        </WorkHolderRight>
      </WorkHolder>
