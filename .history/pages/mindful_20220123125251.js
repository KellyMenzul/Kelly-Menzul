...
export default function MindfulApp() {
  ...
  return (
      <Container>
        ...
        <ProcessHolder>
          <Process text='There is a negative stigma about mental health in today’s society. People from normalizing having an open discussion about their emotions with others.'/>
        </ProcessHolder>
