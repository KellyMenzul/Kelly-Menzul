...
transition:${props=>props.transitionrotate}
`
...
const MenuBar2 = ({
    ...
    return <Holder>
        <Top>
            <MenuIcon transitionrotate={transitionrotate} rotate={rotate} src="/plus.svg" onClick={()=>setOpen(!open)}/>
        </Top>
