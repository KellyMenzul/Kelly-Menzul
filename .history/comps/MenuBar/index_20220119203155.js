...
const MenuBar = ({
    ...
    function setColor(btn, color){
        ...
        if (count == 0){
            document.querySelector('aboutbutton').style.backgroundColor = "#FAD"
            count=1;        
        }
        else{
            document.querySelector('aboutbutton').style.backgroundColor = "#DAD"
            count=0;
        }
    }
    ...
    return <Holder>
        ...
        <Right>
            <MenuButtonHolder>
                <Link href="#about">
                    <MenuButton id="aboutbutton" bgcolor={bgcolor1} onClick={()=>setColor('button', '#101010')}>About</MenuButton>
                </Link>
