...
const MenuBar = ({
    ...
    return <Holder>
        ...
        <Right>
            <MenuButtonHolder>
                <Link href="#about">
                    <MenuButton onClick={changeColor()} bgcolor={bgcolor1} onClick={()=>{onButtonPress()}}>About</MenuButton>
                </Link>

                <Link href="#work">
                <MenuButton onClick={changeColor2()} bgcolor={bgcolor2}>Work</MenuButton>
                </Link>
